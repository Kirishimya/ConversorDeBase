...
def main():
    while 1:
        op = input("1 - Usar calculadora\n2 - Sair\n")
        if op == "2":
            return
        base1 = int(input("Base do primeiro valor base 2 a base 36: "))
        valor1 = input("Primeiro valor: ")
        base2 = int(input("Base do segundo valor base 2 a base 36: "))
        valor2 = input("Segundo valor: ")
        operacao = input("Operação (+, -, *): ")
        base_result = int(input("Base do resultado base 2 a base 36: "))
